...
def write_voxelyze_file(sim, env, individual, run_directory, run_name):
    ...
    voxelyze_file = open(run_directory + "/voxelyzeFiles/" + run_name + "--id_%09i.vxa" % individual.id, "w")
    ...
    voxelyze_file.write(
        ...
        <FitnessFileName>" + run_directory + "/fitnessFiles/softbotsOutput--id_%09i.xml" % individual.id +
        "</FitnessFileName>\n\
        <QhullTmpFile>" + run_directory + "/../_qhull/tempFiles/qhullInput--id_%09i.txt" % individual.id + "</QhullTmpFile>\n\
        <CurvaturesTmpFile>" + run_directory + "/../_qhull/tempFiles/curvatures--id_%09i.txt" % individual.id +
        "</CurvaturesTmpFile>\n\
        </GA>\n\
